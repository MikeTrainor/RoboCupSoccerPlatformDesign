...
KL25=serial.Serial('COM5',256000,timeout=1)#open serial port
...
def main():
    ...
    while(True):
      #  while(KL25.inWaiting()==0):
        ...
        packet = bytearray()
        #packet.append(0x30)
        #packet.append(0x31)  #id
        #packet.append(0x32)  #mtr1
        #packet.append(0x33)  #dir1
        #packet.append(0x34)  #mtr2
        #packet.append(0x35)  #dir2
        #packet.append(0x36)  #kick
        #packet.append(0x37)

        #packet = bytearray()
        packet.append(0xFF)
        packet.append(0x01)  #id
        packet.append(0xFF)  #mtr1
        packet.append(0x0)  #dir1
        packet.append(0xFF)  #mtr2
        packet.append(0x1)  #dir2
        packet.append(0x0)  #kick
        packet.append(0xFF)
